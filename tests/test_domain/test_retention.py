...
Tests TimeRetentionPolicy and HistoryRetentionPolicy: boundary validation,
property calculations, and UTC timezone handling.
...
- HistoryRetentionPolicy per-IP limits prevent unbounded growth
"""
