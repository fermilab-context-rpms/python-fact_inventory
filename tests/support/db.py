...
from fact_inventory.infrastructure.db.models import BackgroundJobLock, FactInventory
...
async def truncate_background_job_lock(session: AsyncSession) -> None:
    """Delete all rows from BackgroundJobLock and commit."""
