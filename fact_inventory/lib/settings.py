...
if "DEPLOYMENT" not in os.environ:  # pragma: no cover
...
class Settings(BaseSettings):
    ...
    api_rate_limit_max_requests: int = Field(default=2, ge=1)
    ...
    max_request_body_mb: int = Field(default=17, ge=1)
    ...
    enable_ready_endpoint: bool = False
    ...
    def _expand_env_vars(self) -> Self:
        ...
        is not set, uses 'default' as fallback value.
