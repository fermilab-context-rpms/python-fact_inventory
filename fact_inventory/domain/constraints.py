...
class JSONFieldSizeConstraint:
    ...
    JSON_FIELD_NAMES = ("system_facts", "package_facts", "local_facts", "agent_facts")
    # Single source of truth: the required-presence check covers the same
    # fields as the size check.  If they ever diverge, introduce a new name.
    JSON_FIELD_NAMES_NEED_ONE_OF = JSON_FIELD_NAMES
